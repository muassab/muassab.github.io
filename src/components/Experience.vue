...
const experiences: ExperienceItem[] = [
  {
    ...
    description:
      "Desenvolvimento de aplicações web escaláveis, integração com APIs de terceiros, foco em agilidade e entrega de valor.",
  ...
  },
  {
    ...
    period: "2022 - 2024",
    description:
      "Desenvolvimento de APIs REST escaláveis de alta carga, integração complexa com múltiplos bancos de dados, implementação de pipelines CI/CD robustos e otimização de armazenamento abrupto de dados.",
    technologies: [
      "Node.js",
      "Nest.js",
      "Typescript",
  ...
  },
  {
    ...
    period: "2022",
    description:
      "Desenvolvimento de plugins de alto desempenho, arquitetando e otimizando sistemas para lidar com demandas intensivas de processamento.",
  ...
  },
  {
    ...
    period: "2016 - 2021",
    description:
      "Desenvolvimento de APIs REST, integração com bancos de dados e implementação de pipelines de CI/CD.",
      ...
      <div class="space-y-8">
        ...
        >
          <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-2 mb-4">
            ...
            <span class="text-text-secondary font-mono text-sm whitespace-nowrap">{{
              exp.period
            }}</span>
          </div>
